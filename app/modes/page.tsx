...
const MODE_ITEMS = [
  ...
  {
    href: '/game/impossible-mode',
    title: 'Impossible Mode',
    subtitle: 'Hardcore challenge set',
    description: 'Landlocked, microstates, suffix rules, and no-map difficulty presets.',
    icon: Skull,
    accent: '#ef4444',
    glow: 'shadow-[0_16px_45px_rgba(239,68,68,0.24)]',
  },
  {
    href: '/game/elimination',
    title: 'Elimination',
    subtitle: 'One mistake = out',
    description: '100 prompts. Survive as long as possible without a single wrong answer.',
    icon: Crown,
    accent: '#f97316',
    glow: 'shadow-[0_16px_45px_rgba(249,115,22,0.24)]',
  },
  {
    href: '/game/zoom-reveal',
    title: 'Zoom Reveal',
    subtitle: 'Map suspense mode',
    description: 'Guess countries from zoomed regions before each round advances.',
    icon: ZoomIn,
    accent: '#0ea5e9',
    glow: 'shadow-[0_16px_45px_rgba(14,165,233,0.24)]',
  },
  {
    ...
    title: 'Chaos Mode',
    subtitle: 'Rules change every 10s',
    description: 'Dynamic constraints rotate rapidly for creator-friendly unpredictable runs.',
    icon: Sparkles,
    accent: '#a855f7',
    glow: 'shadow-[0_16px_45px_rgba(168,85,247,0.24)]',
  },
  {
    href: '/game/daily-boss',
    title: 'Daily Boss',
    subtitle: 'Global hardcore seed',
    description: 'One hard daily challenge for everyone. Race for top position each day.',
    icon: Camera,
    accent: '#14b8a6',
    glow: 'shadow-[0_16px_45px_rgba(20,184,166,0.24)]',
  },
  {
    href: '/duel',
    title: '1v1 Duel',
